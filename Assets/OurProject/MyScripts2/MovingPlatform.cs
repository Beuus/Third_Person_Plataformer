...
public class MovingPlatform : MonoBehaviour {
	...
	void _DoMovement()
	{
        // TODO 1 - Obtener la dirección (posicion del waypoint - mi posicion) del desplazamiento y normalizarla
        Vector3 direction = m_CurrentWaypoint.position - transform.position;
        direction.Normalize();
        // TODO 2 - Mover la plataforma en función de la dirección obtenida, la velocidad, y el deltaTime (movimiento sin aceleración)
